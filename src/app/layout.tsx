...
<Link href="/" className="font-semibold tracking-tight">SilentVerse</Link>
...
<Link href="/dashboard" className="rounded-md bg-gray-900 px-3 py-1.5 text-white hover:bg-gray-700">Dashboard</Link>
</div>
</nav>
</header>
