...
<Card title="Learning Hub" href="/learn" desc="Courses, lessons, progress" />
<Card title="Global Chat" href="/chat" desc="Realtime conversation" />
<Card title="Social Feed" href="/feed" desc="Posts, media, comments" />
<Card title="Marketplace" href="/market" desc="Curated, buy-only" />
<Card title="Profile" href="/u/you" desc="Timeline & badges" />
<Card title="Dashboard" href="/dashboard" desc="Your activity & stats" />
</div>
</section>
)
}
